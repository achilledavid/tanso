        ...
        (event: KeyboardEvent) => {
            if (listeningForKey) {
                ...
                if (event.key === " " || event.code === "Space") {
                    onAssignShortcut("Space")
                } else if (event.key !== "Space") {
                    onAssignShortcut(event.key)
                }
        ...
        <ContextMenu.Root onOpenChange={(open) => open && handleContextMenuOpen()}>
            ...
            <ContextMenu.Portal>
                ...
                >
                    ...
                    >
                        {listeningForKey ? "Appuyez sur une touche..." : currentShortcut ? `Raccourci actuel: ${currentShortcut}` : "Assigner un raccourci"}
                    </ContextMenu.Item>
                </ContextMenu.Content>
            </ContextMenu.Portal>
        </ContextMenu.Root>
